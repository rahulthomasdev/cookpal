...
import FavCardGridWithPagination from "../../../components/favCardGrid/favCardGid";

const { Header, Content, Footer, Sider } = Layout;
const FavoritesPage = () => {
  const favRecipesData = [
    {
      imgPath:
        ...
        >
          ...
          <div className="w-full mt-2">
            <span className="text-slate-400 text-xl font-semibold">
              Discover Recipes You Love
            </span>
          </div>
          <div className="w-full mt-5 __explore_recipe">
            <FavCardGridWithPagination recipesData={favRecipesData} />
          </div>
        </div>
      </Content>
      <Footer
